...
const prisma_1 = __importDefault(require("../utils/prisma")); // Prisma Client
...
const generateCustomToken = async (req, res) => {
    ...
    try {
        ...
        const userRecord = await firebaseAdmin_1.default.auth().getUserByEmail(email);
        ...
        const customToken = await firebaseAdmin_1.default.auth().createCustomToken(userRecord.uid, {
            role: userInDb.role,
            userId: userInDb.id,
